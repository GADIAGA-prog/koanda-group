...
export const navigation = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Industrie & Énergie", path: "/filiales#industrie" },
...
Rejoignez-nous pour transformer l’énergie!`,
  ...
  },
  {
    ...
    facts: [
      ...
      "Canal client : call center et page Facebook Belchicken",
    ],
    externalLink: "https://www.facebook.com/belchickenburkina",
    externalLabel: "Page Facebook Belchicken",
    focusCards: [
      {
        tag: "Structure",
      ...
      {
        tag: "Offre",
        title: "Une carte gourmande et visuelle",
        ...
        image: {
          ...
          alt: "Kebab wrap — franchise Belchicken",
          fit: "cover",
          position: "center center",
        },
      },
      {
        ...
        text: "La franchise sert aussi bien un repas individuel, une pause snack qu’une commande plus généreuse, ce qui renforce son attractivité auprès d’une clientèle jeune et familiale.",
        image: {
      ...
      {
        tag: "Relation client",
        title: "Un lien commercial direct avec la clientèle",
        text: "Un call center dédié et une présence active sur les réseaux sociaux soutiennent la prise de commande, la visibilité de la marque et la fidélisation client.",
        image: {
